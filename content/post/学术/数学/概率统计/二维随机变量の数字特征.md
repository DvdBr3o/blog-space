...
lastmod: 2026-01-04T22:19:01+08:00
tags:
  - 概率统计
  - 二维随机变量
categories: 概率统计
...
1. 【定义】
	1. $\mathrm{Cov}(X,Y)=\rho_{XY}\sqrt{ D(X) }\sqrt{ D(Y) }$
...
>
>1. **独立 $\Rightarrow$ 不相关**
>2. 相关 $\Leftrightarrow$ $x,y$ 存在线性关系 $ax+by=c$
>3. 不独立 $\Leftrightarrow$ $x,y$ 存在关系 e.g. $x^{2}+y^{2}=1$
