...
lastmod: 2025-01-13T13:56:39+08:00
tags:
  - 高等数学
  - 多元
  - 积分
...
即
$$
\iint _{S}f(x,y,z(x,y)) \, dS=\iint_{D}f(x,y,z(x,y))\cdot\sqrt{ 1+z_{x}^{2}+z_{y}^{2} }\,d\delta 
$$
...
$$
\iint_{S}\vec{F}\cdot \vec{n}\,dS=\iint_{S} (-P\cdot f_{x}-Q\cdot f_{y}+R)\,d\delta
$$
