...
lastmod: 2026-01-06T23:38:12+08:00
tags:
  - 离散数学
  - 图论
categories: 离散数学
...
- 连通性
	...
	- 有向图 (精髓：强连通缩点)
		- 强连通 := $\forall u\forall v (u\to v \land v\to u)$ $\Leftrightarrow$ **存在经过每个顶点至少一次の通路**
		- 单向连通 := $\forall u\forall v(u\to v\lor v\to u)$
		- 弱连通 := 基图是连通图
		- 强 $\Rightarrow$ 单向 $\Rightarrow$ 弱
